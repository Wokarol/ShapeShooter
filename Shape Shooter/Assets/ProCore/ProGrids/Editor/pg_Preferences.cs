...
namespace ProGrids
{
	public class pg_Preferences
	{
		...
		public static void SetPreferences()
		{
			...
			EditorPrefs.SetString("gridColorX", _gridColorX.ToString("f3", System.Globalization.CultureInfo.InvariantCulture));
			EditorPrefs.SetString("gridColorY", _gridColorY.ToString("f3", System.Globalization.CultureInfo.InvariantCulture));
			EditorPrefs.SetString("gridColorZ", _gridColorZ.ToString("f3", System.Globalization.CultureInfo.InvariantCulture));
